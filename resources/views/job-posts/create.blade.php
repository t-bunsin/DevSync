...
@section('title', __('ui.bo.job_posts.create_title') . ' | ZIN-WORKS Admin')
...
@section('main-content')
    <div class="kh-bo">
        <nav class="kh-bo__breadcrumb" aria-label="{{ __('ui.admin.a11y.breadcrumb') }}">
            ...
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M9 6l6 6-6 6" /></svg>
            <span aria-current="page">{{ __('ui.bo.job_posts.create_title') }}</span>
        </nav>

        <header class="kh-bo__head">
            <div>
                <h1>{{ __('ui.bo.job_posts.create_title') }}</h1>
                <p>{{ __('ui.bo.job_posts.create_subtitle') }}</p>
            </div>
